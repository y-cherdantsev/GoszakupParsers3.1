...
@brief Класс глобальных конфигураций и констант
    ...
    */
    ...
    public static class Configuration
    {
        ...
        internal static string DbAnnouncements { get; set; } /*!< Имя таблицы договоров гос. закупа */
...
@throw Exception - непредвиденные исключение
     ...
     */
        public static void LoadConfiguration()
        {
            ...
            Console.Title = "Goszakup Announcements Parse";
            ...
            DbAnnouncements = getConfiguration["Configuration:DbAnnouncements"];
