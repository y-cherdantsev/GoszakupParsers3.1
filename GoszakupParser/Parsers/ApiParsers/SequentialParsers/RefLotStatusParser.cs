...
namespace GoszakupParser.Parsers.ApiParsers.SequentialParsers
{
    ...
    {
        /// <inheritdoc />
        public RefLotStatusParser(Configuration.ParserSettings parserSettings, string authToken) : base(
            parserSettings, authToken)
        {
        }

        /// <inheritdoc />
        protected override RefLotStatusGoszakup DtoToModel(RefLotStatusDto dto)
        {
