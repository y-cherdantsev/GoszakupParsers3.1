...
@param[in] connection - соединение с базой данных
     ...
     */
        public static void AddParticipant(ParticipantDb participant, NpgsqlConnection connection)
        {
            ...
            cmd.Parameters.AddWithValue("@inn", !string.IsNullOrEmpty(participant.inn) ? (object) participant.inn.Trim() : DBNull.Value);
            cmd.Parameters.AddWithValue("@unp", !string.IsNullOrEmpty(participant.unp) ? (object) participant.unp.Trim() : DBNull.Value);
            ...
            cmd.Parameters.AddWithValue("@number_reg", !string.IsNullOrEmpty(participant.number_reg) ? (object) participant.number_reg.Trim() : DBNull.Value);
            cmd.Parameters.AddWithValue("@series", !string.IsNullOrEmpty(participant.series) ? (object) participant.series.Trim() : DBNull.Value);
            cmd.Parameters.AddWithValue("@name_ru", !string.IsNullOrEmpty(participant.name_ru) ? (object) participant.name_ru.Trim() : DBNull.Value);
            cmd.Parameters.AddWithValue("@name_kz", !string.IsNullOrEmpty(participant.name_kz) ? (object) participant.name_kz.Trim() : DBNull.Value);
            cmd.Parameters.AddWithValue("@full_name_ru", !string.IsNullOrEmpty(participant.full_name_ru) ? (object) participant.full_name_ru.Trim() : DBNull.Value);
            cmd.Parameters.AddWithValue("@full_name_kz", !string.IsNullOrEmpty(participant.full_name_kz) ? (object) participant.full_name_kz.Trim() : DBNull.Value);
            ...
            cmd.Parameters.AddWithValue("@ref_kopf_code", !string.IsNullOrEmpty(participant.ref_kopf_code) ? (object) participant.ref_kopf_code.Trim() : DBNull.Value);
            ...
            cmd.Parameters.AddWithValue("@email", !string.IsNullOrEmpty(participant.email) ? (object) participant.email.Trim() : DBNull.Value);
            cmd.Parameters.AddWithValue("@phone", !string.IsNullOrEmpty(participant.phone) ? (object) participant.phone.Trim() : DBNull.Value);
