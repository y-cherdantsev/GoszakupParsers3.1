     ...
     */
        public static void AddLot(LotDb lot, NpgsqlConnection connection)
        {
            ...
            cmd.Parameters.AddWithValue("@lot_number",
                !string.IsNullOrEmpty(lot.lot_number) ? (object) lot.lot_number.Trim() : DBNull.Value);
            ...
            cmd.Parameters.AddWithValue("@name_ru",
                !string.IsNullOrEmpty(lot.name_ru) ? (object) lot.name_ru.Trim() : DBNull.Value);
            cmd.Parameters.AddWithValue("@name_kz",
                !string.IsNullOrEmpty(lot.name_kz) ? (object) lot.name_kz.Trim() : DBNull.Value);
            cmd.Parameters.AddWithValue("@description_ru",
                !string.IsNullOrEmpty(lot.description_ru) ? (object) lot.description_ru.Trim() : DBNull.Value);
            cmd.Parameters.AddWithValue("@description_kz",
                !string.IsNullOrEmpty(lot.description_kz) ? (object) lot.description_kz.Trim() : DBNull.Value);
            cmd.Parameters.AddWithValue("@customer_id", lot.customer_id);
            cmd.Parameters.AddWithValue("@customer_bin", lot.customer_bin);
            cmd.Parameters.AddWithValue("@trd_buy_number_anno",
                !string.IsNullOrEmpty(lot.trd_buy_number_anno)
                    ? (object) lot.trd_buy_number_anno.Trim()
                    : DBNull.Value);
            ...
            cmd.Parameters.AddWithValue("@customer_name_kz",
                !string.IsNullOrEmpty(lot.customer_name_kz) ? (object) lot.customer_name_kz.Trim() : DBNull.Value);
            cmd.Parameters.AddWithValue("@customer_name_ru",
                !string.IsNullOrEmpty(lot.customer_name_ru) ? (object) lot.customer_name_ru.Trim() : DBNull.Value);
